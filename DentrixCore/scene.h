...
public:
    ...
    void Draw(Shader* shader, Mesh* selectedMesh, glm::mat4& selectedToothGizmoModelMatrix, bool isUpperJawSelected,
...
private:
    static bool RayTriangleIntersect(const glm::vec3& rayOrigin, const glm::vec3& rayDirection, const glm::vec3& v0,
