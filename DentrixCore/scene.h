...
public:
	...
	bool Intersect(glm::vec3 ray_origin, glm::vec3 ray_direction, glm::mat4 SceneMatrix,
	...
	static void GetNeighboringMeshNames(std::string meshName, std::string& neighbor1Name,
	                                    std::string& neighbor2Name);

private:
	static bool RayTriangleIntersect(const glm::vec3& rayOrigin, const glm::vec3& rayDirection,
